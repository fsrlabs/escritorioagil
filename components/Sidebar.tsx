...
export default function Sidebar({ empresas, activeIndex, onSelectEmpresa, onShowOverview }: SidebarProps) {
  return (
    <div className={styles.sidebar}>
      ...
      <div className={styles.section} style={{ marginTop: 8 }}>Empresas</div>
      {empresas.map((e, i) => (
        <div
          key={e.name}
      ...
      <div className={styles.footer}>
        <div className={styles.footerName}>Rodrigo Mendes</div>
        <div className={styles.footerEmail}>rodrigo@escritorioagil.com.br</div>
      </div>
    </div>
  );
}
